...
def sample_sampledqn_params(trial: optuna.Trial, n_actions: int, n_envs: int, additional_args: dict) -> dict[str, Any]:
    ...
    # From 2**3=4 to 2**9=512
    n_sampled_actions_exp_pow = trial.suggest_int("n_sampled_actions_exp_pow", 2, 9)
    ...
    sampling_strategy = trial.suggest_categorical("sampling_strategy", ["uniform", "gaussian"])
    train_sampling_strategy = trial.suggest_categorical("train_sampling_strategy", ["uniform", "gaussian"])
